    ...
    <section>
        ...
        <div class="row">
            <div class="col-6 col-12-small">
                ...
                <p>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing gravida odio porttitor sem non mi integer non
                    ...
                    Semper adipiscing varius montes viverra nibh in adipiscing blandit tempus accumsan.</p>
            </div>
            <div class="col-6 col-12-small">
            ...
            <div class="col-4 col-12-medium">
                ...
                <p>Nunc lacinia ante nunc ac lobortis. Interdum adipiscing gravida odio porttitor sem non mi integer non
                    ...
                    varius montes viverra nibh in adipiscing blandit.</p>
            </div>
            <div class="col-4 col-12-medium">
        ...
        <div class="row gtr-200">
            <div class="col-6 col-12-medium">
                ...
                <!-- Blockquote -->
                <h3>Blockquote</h3>
                <blockquote>Lorem ipsum dolor vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu
                    felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac pellentesque praesent. Lorem ipsum
                    dolor. Lorem ipsum dolor vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu
                    felis iaculis volutpat ac adipiscing accumsan eu faucibus.</blockquote>
            ...
            <div class="col-6 col-12-medium">
                ...
                <div class="box alt">
                    <div class="row gtr-50 gtr-uniform">
                        <div class="col-4"><span class="image fit"><img src="{{ asset('images/pic01.jpg') }}"
                                    alt="" /></span></div>
                        <div class="col-4"><span class="image fit"><img src="{{ asset('images/pic02.jpg') }}"
                                    alt="" /></span>
                        </div>
                        <div class="col-4"><span class="image fit"><img src="{{ asset('images/pic03.jpg ')}}"
                                    alt="" /></span>
                        </div>
                        <!-- Break -->
                        <div class="col-4"><span class="image fit"><img src="{{ asset('images/pic03.jpg') }}"
                ...
                <h4>Left &amp; Right</h4>
                <p><span class="image left"><img src="{{ asset('images/pic01.jpg') }}" alt="" /></span>Lorem ipsum dolor sit
                    accumsan
                    ...
                    praesent.</p>
                <p><span class="image right"><img src="{{ asset('images/pic02.jpg') }}" alt="" /></span>Lorem ipsum dolor
                    sit accumsan
                    interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in
                    faucibus vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus.
                    Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum
                ...
                <div class="box">
                    <p>Felis sagittis eget tempus primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis
                        ...
                        sagittis eget. tempus euismod. Magna sed etiam ante ipsum primis in faucibus vestibulum.</p>
                </div>
